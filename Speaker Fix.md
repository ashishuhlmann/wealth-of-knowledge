...
3. Go to the [sof-bin](https://github.com/thesofproject/sof-bin.git), and download the missing files. Add them to the locations above. Sometimes, the filenames from the sof-bin repository don't quite match. Just find the closest one and rename it to whatever the terminal output was.
